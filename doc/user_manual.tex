...
For HTTP, you can set the UserAgent values, using a frequency for each
value (the sum of all frequencies must be equal to 100)
...
variables (\strong{Warn: before version, 1.0.4, the argument was just the
  Pid !}).
...
\strong{New in 1.0.4}: If you don't use the distributed feature of
