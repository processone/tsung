...
History:
\begin{itemize}
\item \program{IDX-Tsunami} is being developped since 2001 
...
Mesures and statistics produced by Tsunami are extremely featurefull.
...
\item xmerl-0.19 (\url{http://sowap.sourceforge.net/download.html}). A debian
  ...
  \item for distributed tests, you need an ssh access to remote
    machines without passwd (use a RSA/DSA key without passphrase or
    ssh-agent)
\end{itemize}
