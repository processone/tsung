...
\begin{itemize}
\item Erlang/OTP R9C-0 and up (included R10B-1a, but R9C-2 is recommended)
...
apply this patch to make it work. This is fixed in erlang R9C-1 and up.
