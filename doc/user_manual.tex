...
This is used to set the local ack timeout and global ack timeout(ms). 
By default, local ack timeout will be 10min(600000) and global ack timeout will
be \userinput{infinity}. This value can be changed like this:

\begin{Verbatim}
  <option name="local_ack_timeout" value="300000"></option>
