...
\subsection{Jabber benchmark approach}
...
\subsubsection{Acknowledgements of messages}
...
A new way to analyse the server response has been introduced in the
...
\item[error\_unknown\_data] Data received from the server during a
  ...
  aborted.
\item[error\_unknown\_msg] Unknown message receveived (see the log
