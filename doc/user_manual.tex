...
supported. An experimental LDAP plugin was included in the 1.3.0 release. 
...
\section{WEBDAV benchmark approach}
...
hand (an example is provided in \ref{sec:sessions:ldap}).
