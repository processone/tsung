...
check_handshake(Response, Accept) ->
    ...
    case http_util:parse_headers(#http{}, RespString) of
        {ok, Result=#http{status = 101}} ->
            ...
            case http_util:check_headers(Result#http.headers, RequiredHeaders) of
                true ->
